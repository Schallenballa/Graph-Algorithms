...
public class GraphAlgorithms {
	...
	public static void main(String[] args) throws IOException {
		...
		KruskalAlgorithm kGraph = new KruskalAlgorithm();
		floydWarshall fWGraph = new floydWarshall();
		...
		while (sc.hasNext()) {
			...
			case 2:
				...
				kGraph.initializeData(arrayData, vert);
				break;

			case 3:
				System.out.println();
				System.out.println("You chose Floyd-Warshall's algorithm.");
				fWGraph.initializeData(arrayData, vert);
				break;
